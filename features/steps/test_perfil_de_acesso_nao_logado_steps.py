...
from features.steps.test_login_steps import step_impl, step_click_next_button
import logging
...
def step_redirecionado_tela_login(context):
    assert context.perfil_nao_logado_page.validar_redirecionamento_para_login(), \
...
def step_validar_mensagem_acesso_negado(context):
    ...
    assert mensagem == "Usuário deve realizar login antes de acessar uma funcionalidade do sistema", \
