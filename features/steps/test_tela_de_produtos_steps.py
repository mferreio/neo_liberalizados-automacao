...
def step_exibir_produtos(context):
    ...
    for produto in produtos:
        logging.info(f"Mês: {produto['mes']}, Ano: {produto['ano']}, Perfil: {produto['perfil']}, Submercado: {produto['submercado']}, Tipo de Produto: {produto['tipo']}")

    # Exibe os produtos no console
    for produto in produtos:
        print(f"Mês: {produto['mes']}, Ano: {produto['ano']}, Perfil: {produto['perfil']}, Submercado: {produto['submercado']}, Tipo de Produto: {produto['tipo']}")
...
def step_exibir_produtos_atualizados(context):
    ...
    context.tela_de_produtos_page = TelaDeProdutosPage(context.driver)
    novos_produtos = context.tela_de_produtos_page.obter_novos_produtos(context.produtos_anteriores)
