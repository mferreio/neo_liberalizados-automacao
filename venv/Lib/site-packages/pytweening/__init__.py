...
def iterEaseInPoly(startX, startY, endX, endY, intervalSize, degree=2):
    ...
    and 1.0 last no matter the intervalSize."""
    return iter(
        _iterTween(startX, startY, endX, endY, intervalSize, easeInPoly, degree)
    )
...
def iterEaseOutPoly(startX, startY, endX, endY, intervalSize, degree=2):
    ...
    and 1.0 last no matter the intervalSize."""
    return iter(
        _iterTween(startX, startY, endX, endY, intervalSize, easeOutPoly, degree)
    )
...
def iterEaseInOutPoly(startX, startY, endX, endY, intervalSize, degree=2):
    ...
    and 1.0 last no matter the intervalSize."""
    return iter(
        _iterTween(startX, startY, endX, endY, intervalSize, easeInOutPoly, degree)
    )
...
def iterEaseInElastic(
    startX, startY, endX, endY, intervalSize, amplitude=1, period=0.3
):
    ...
    return iter(
        _iterTween(
            startX, startY, endX, endY, intervalSize, easeInElastic, amplitude, period
        )
    )
...
def iterEaseOutElastic(
    ...
    return iter(
        _iterTween(
            startX, startY, endX, endY, intervalSize, easeOutElastic, amplitude, period
        )
    )
...
def iterEaseInOutElastic(
    startX, startY, endX, endY, intervalSize, amplitude=1, period=0.5
):
