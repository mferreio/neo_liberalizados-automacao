...
class CT_RegularTextRun(BaseOxmlElement):
    ...
    rPr: CT_TextCharacterProperties | None = ZeroOrOne(
...
class CT_TextBody(BaseOxmlElement):
    ...
    bodyPr: CT_TextBodyProperties = OneAndOnlyOne(
        "a:bodyPr"
    )  # pyright: ignore[reportAssignmentType]
...
class CT_TextCharacterProperties(BaseOxmlElement):
    ...
    b: bool | None = OptionalAttribute(
        "b", XsdBoolean
    )  # pyright: ignore[reportAssignmentType]
    i: bool | None = OptionalAttribute(
        "i", XsdBoolean
    )  # pyright: ignore[reportAssignmentType]
...
class CT_TextParagraph(BaseOxmlElement):
    ...
    def content_children(
        self,
    ) -> tuple[CT_RegularTextRun | CT_TextLineBreak | CT_TextField, ...]:
...
class CT_TextSpacing(BaseOxmlElement):
    ...
    # implemented yet.
    spcPct: CT_TextSpacingPercent | None = ZeroOrOne(
        "a:spcPct"
    )  # pyright: ignore[reportAssignmentType]
    spcPts: CT_TextSpacingPoint | None = ZeroOrOne(
        "a:spcPts"
    )  # pyright: ignore[reportAssignmentType]
