...
class _BaseGroupShapes(_BaseShapes):
    ...
    def add_textbox(
        self, left: Length, top: Length, width: Length, height: Length
    ) -> Shape:
...
class LayoutPlaceholders(BasePlaceholders):
    ...
    def get(
        self, idx: int, default: LayoutPlaceholder | None = None
...
class NotesSlidePlaceholders(MasterPlaceholders):
    ...
    def _shape_factory(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        return cast(
            NotesSlidePlaceholder, _NotesSlideShapeFactory(placeholder_elm, self)
        )
