        ...
        try:
            ...
            while True:
                ...
                if markerHigh != 0xFF or markerLow < 0xC0:
                    ...
                    markerLow == 0xC8  # JPG
                    or (markerLow >= 0xD0 and markerLow <= 0xD9)  # RSTx
                    ...
                    if (
                        (markerLow >= 0xC0 and markerLow <= 0xC3)  # SOF0 - SOF3
                        or (markerLow >= 0xC5 and markerLow <= 0xC7)  # SOF4 - SOF7
                        or (markerLow >= 0xC9 and markerLow <= 0xCB)  # SOF9 - SOF11
