...
def contenttypes():
    ...
    for extension in filetypes:
        attrs = {"Extension": extension, "ContentType": filetypes[extension]}
...
def picture(
    ...
    imageAngle = {1: 0, 2: 0, 3: 180, 4: 0, 5: 90, 6: 90, 7: 270, 8: 270}[
        imageOrientation
    ]
    ...
    blipfill.append(
        makeelement(
            "blip", nsprefix="a", attrnsprefix="r", attributes={"embed": picrelid}
        )
    )
    ...
    xfrm.append(
        makeelement("ext", nsprefix="a", attributes={"cx": width, "cy": height})
    )
    ...
    graphicdata = makeelement(
        ...
        nsprefix="a",
        attributes={
            "uri": ("http://schemas.openxmlformats.org/drawingml/200" "6/picture")
        },
    )
    ...
    extent = makeelement(
        "extent", nsprefix="wp", attributes={"cx": width, "cy": height}
    )
    inline = makeelement(
        "inline",
